...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/louart/Bureau/these/partie_pratique/experience/test_hls/sinus/vivado/sinus_step_start/sinus_step_start.cache/compile_simlib/modelsim"
  fi
