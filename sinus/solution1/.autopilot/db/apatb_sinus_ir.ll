...
define void @apatb_sinus_ir(i1 %start, i1 %step, %"class.hls::stream"* %signal_1, %"class.hls::stream"* %signal_2) local_unnamed_addr #0 {
entry:
  %signal_1_copy1 = alloca %"class.hls::stream", align 512
  %signal_2_copy2 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %signal_1, %"class.hls::stream"* nonnull align 512 %signal_1_copy1, %"class.hls::stream"* %signal_2, %"class.hls::stream"* nonnull align 512 %signal_2_copy2)
  call void @apatb_sinus_hw(i1 %start, i1 %step, %"class.hls::stream"* %signal_1_copy1, %"class.hls::stream"* %signal_2_copy2)
  call fastcc void @copy_out(%"class.hls::stream"* %signal_1, %"class.hls::stream"* nonnull align 512 %signal_1_copy1, %"class.hls::stream"* %signal_2, %"class.hls::stream"* nonnull align 512 %signal_2_copy2)
  ret void
}
...
declare void @apatb_sinus_hw(i1, i1, %"class.hls::stream"*, %"class.hls::stream"*)

define void @sinus_hw_stub_wrapper(i1, i1, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  call void @sinus_hw_stub(i1 %0, i1 %1, %"class.hls::stream"* %2, %"class.hls::stream"* %3)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  ret void
}

declare void @sinus_hw_stub(i1, i1, %"class.hls::stream"*, %"class.hls::stream"*)
