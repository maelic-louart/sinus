; ModuleID = '/home/louart/Bureau/these/partie_pratique/experience/test_hls/sinus/vitis_hls/sinus_step_start/sinus/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sinus_ir(i1 %start, i1 %debug, i1 %step, %"class.hls::stream"* %angle, %"class.hls::stream"* %sinus_1, %"class.hls::stream"* %sinus_2) local_unnamed_addr #0 {
entry:
  %angle_copy1 = alloca %"class.hls::stream", align 512
  %sinus_1_copy2 = alloca %"class.hls::stream", align 512
  %sinus_2_copy3 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %angle, %"class.hls::stream"* nonnull align 512 %angle_copy1, %"class.hls::stream"* %sinus_1, %"class.hls::stream"* nonnull align 512 %sinus_1_copy2, %"class.hls::stream"* %sinus_2, %"class.hls::stream"* nonnull align 512 %sinus_2_copy3)
  call void @apatb_sinus_hw(i1 %start, i1 %debug, i1 %step, %"class.hls::stream"* %angle_copy1, %"class.hls::stream"* %sinus_1_copy2, %"class.hls::stream"* %sinus_2_copy3)
  call fastcc void @copy_out(%"class.hls::stream"* %angle, %"class.hls::stream"* nonnull align 512 %angle_copy1, %"class.hls::stream"* %sinus_1, %"class.hls::stream"* nonnull align 512 %sinus_1_copy2, %"class.hls::stream"* %sinus_2, %"class.hls::stream"* nonnull align 512 %sinus_2_copy3)
  ret void
}
...
declare void @apatb_sinus_hw(i1, i1, i1, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @sinus_hw_stub_wrapper(i1, i1, i1, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  call void @sinus_hw_stub(i1 %0, i1 %1, i1 %2, %"class.hls::stream"* %3, %"class.hls::stream"* %4, %"class.hls::stream"* %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  ret void
}

declare void @sinus_hw_stub(i1, i1, i1, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)
