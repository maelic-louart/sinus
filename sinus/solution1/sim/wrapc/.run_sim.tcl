...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sinus.autotvin.dat"
	set constFileTvOut       "sinus.autotvout.dat"
	set constFileHdlTvIn     "sinus.autohdltvin.dat"
	set constFileHdlTvOut    "sinus.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
