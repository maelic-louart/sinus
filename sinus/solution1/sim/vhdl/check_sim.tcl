...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sinus.autotvin_start_r.dat"
         "c.sinus.autotvin_debug.dat"
         "c.sinus.autotvin_step.dat"
         "c.sinus.autotvin_angle_V.dat"
         "c.sinus.autotvin_sinus_1_V.dat"
         "c.sinus.autotvin_sinus_2_V.dat"
         "c.sinus.autotvout_sinus_1_V.dat"
         "c.sinus.autotvout_sinus_2_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sinus.autotvout_sinus_1_V.dat"
         "rtl.sinus.autotvout_sinus_2_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
